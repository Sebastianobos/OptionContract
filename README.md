...
Before expiration only the buyer can exercise the funcion and receive `min(max(0, underlyingPrice - strike), balanceOfContract)`. The remaining ETH in the contract are sent to the seller. 
